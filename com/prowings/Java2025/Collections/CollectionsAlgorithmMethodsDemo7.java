...
public class CollectionsAlgorithmMethodsDemo7 {
	public static void main(String[] args) {
		...
		System.out.println("Min is :"+Collections.min(studentList, new StudentMarksComparator()));
		System.out.println("Max is :"+Collections.max(studentList, new StudentMarksComparator()));
	}
